...
### 💊 OTC 병용 금기/상호작용 규칙 (신규)
- `data/otc_rules.json` 기반으로 다음 로직이 적용됩니다.
  - **중복 성분 방지**: 아세트아미노펜 vs NSAID 중복 추천 금지, 클래스별 최대 1개
  - **상호작용 회피**: 카페인-진해제, MAOI-충혈완화제, 알코올-진정성 성분 등 회피
  - **기저질환/상태 고려(조건부 금기)**: 고혈압(충혈완화제 금기), 전립선비대(진정성 항히스타민/충혈완화제 주의), 녹내장(항히스타민/충혈완화제 금기), 간/신장 기능 저하(아세트아미노펜/NSAID 제한), 음주(진정 성분 금기) 등
- 관리자 모드 > 설정 탭에서 규칙 JSON을 불러오기/수정/백업할 수 있습니다.
...
- **매일 자정(00:00 KST)**: 시스템 정리 및 백업
- **매일 03:00 KST**: 로그 품질 재산정(regrade, 기준 0.6)
- **매 30분**: 시스템 상태 확인
